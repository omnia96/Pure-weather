...
export default Vue.extend({
  data() {
    const popularCities: Array<{id: string, provinceZh: string, leaderZh: string, cityZh: string}> = [];
    return {
      text: '',
      Index: {},
      SearchHistory: null,
  ...
  methods: {
    ...
    addThis(city: {id: string, provinceZh: string, leaderZh: string, cityZh: string}) {
      this.AddToStar(city);
    },
    AddToStar(value:any) {
      const StarCityList = [];
